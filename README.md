...
PulseOS is a neon-inspired mini operating system built for the M5StickS3 (ESP32-S3).
It combines arcade-style gameplay, hardware utilities, and a sci-fi interface into a cohesive embedded experience designed for portability and experimentation.
